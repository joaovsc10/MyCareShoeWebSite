    ...
    <div class="page">
                ...
                <ul class="list-inline navbar-contact-list">
                  ...
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                      ...
                      <div class="unit-body"><a href="mailto:#">mycareshoe@gmail.com</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="index.php">My Profile</a>
                      </li>
      ...
      <!--    <div class="row justify-content-center">
					  ...
					  <table class="table table-striped">
						...
						include('C:/xampp/htdocs/mycareshoe/patient_search_all.php');
						?>	
      ...
      <!--RODAPÉ-->
        ...
        <a class="section section-banner" target="_blank" style="background-color:gainsboro; background-color:gainsboro;"></a>
