      ...
      <div class="container">
          <div class="row justify-content-center">
              <div class="col-xl-8 text-center">
                  <h1 class="font-weight-bold wow fadeInLeft">Add patient information</h1>
                  <p class="intro-description wow fadeInRight"> You can create a new personal information entry for a new user</p>
              </div>
          </div>
      </div>
  </section>
