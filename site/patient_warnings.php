        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 text-center">
                    ...
                    <p class="intro-description wow fadeInRight">You can search, within a time interval accurately down to the minute, for the warnings generated by the patient's sensor readings</p>
                </div>
            </div>
        </div>
    </section>
